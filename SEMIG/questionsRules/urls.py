...
urlpatterns = [
    ...
    path("<int:question_id>/lottery/", views.lotteryRules, name= "lotteryRules"),
    path("<int:question_id>/resp/", views.resp, name= "resp"),
    path("<int:question_id>/loteryresp/", views.loteryresp, name= "loteryresp"),
    path("<int:question_id>/Prueba/<tarea>/<sugesstion>/<respuestas>", views.Prueba, name= "Prueba"),
